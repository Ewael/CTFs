...
Author: Ewaël - following [the writeup from the Cryptohack team](https://blog.cryptohack.org/cryptoctf2020#classic)

![enonce](enonce.png)

The given text is as follow:
...
At first I thought this was some kind of base64 encoding and that the groups of length 5 were lures. It turns out that it has nothing to do with encoding, but I have to determine the correct length for chunks.

```
[+] groups of length 1: 55 unique groups
[+] groups of length 2: 240 unique groups
[+] groups of length 3: 47 unique groups
[+] groups of length 4: 411 unique groups
[+] groups of length 5: 442 unique groups
[+] groups of length 6: 218 unique groups
[+] groups of length 7: 427 unique groups
[+] groups of length 8: 376 unique groups
[+] groups of length 9: 292 unique groups
```

Then I build a list of chunks to measure their frequences in order to create my substitution table:

```
frequences:

[('0PU', 175), ('K2L', 125), ('kMB', 83), ('9It', 69), ('U2b', 69), ('Ho7', 67), ('GwL', 63), ('9HJ', 57), ('kMi', 52), ('DAf', 52), ('G5j', 43), ('vfQ', 35), ('hdJ', 32), ('VnZ', 23), ('iGL', 23), ('jiS', 21), ('8Ni', 16), ('V2a', 16), ('Fum', 16), ('LN4', 16), ('HL1', 13), ('YR5', 10), ('i7O', 8), ('fVK', 7), ('vH9', 7), ('FP1', 7), ('b7U', 5), ('6sb', 5), ('w8t', 4), ('F5o', 3), ('qwU', 3), ('4BK', 2), ('qAv', 2), ('2Q3', 2), ('i4a', 2), ('eV5', 1), ('IAK', 1), ('c3R', 1), ('e0X', 1), ('Oxr', 1), ('2cs', 1), ('8SC', 1), ('H6J', 1), ('f0P', 1), ('3g7', 1), ('Ber', 1), ('0wd', 1)]
----
substitution table:

{'0PU': ' ', 'K2L': 'a', 'kMB': 'b', '9It': 'c', 'U2b': 'd', 'Ho7': 'e', 'GwL': 'f', '9HJ': 'g', 'kMi': 'h', 'DAf': 'i', 'G5j': 'j', 'vfQ': 'k', 'hdJ': 'l', 'VnZ': 'm', 'iGL': 'n', 'jiS': 'o', '8Ni': 'p', 'V2a': 'q', 'Fum': 'r', 'LN4': 's', 'HL1': 't', 'YR5': 'u', 'i7O': 'v', 'fVK': 'w', 'vH9': 'x', 'FP1': 'y', 'b7U': 'z', '6sb': 'A', 'w8t': 'B', 'F5o': 'C', 'qwU': 'D', '4BK': 'E', 'qAv': 'F', '2Q3': 'G', 'i4a': 'H', 'eV5': 'I', 'IAK': 'J', 'c3R': 'K', 'e0X': 'L', 'Oxr': 'M', '2cs': 'N', '8SC': 'O', 'H6J': 'P', 'f0P': 'Q', '3g7': 'R', 'Ber': 'S', '0wd': 'T'}
```

After using a quick simple solver for easy substitution ciphers, the flag appears:

`CCTF{The_main_classical_cipher_types_are_substitution_ciphers}`

And here is my own full script based on the solution:
